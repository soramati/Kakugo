    ...
    <div class="create_page ">
        <form class="max-w-md mx-auto" action="/goals" method="POST">
            ...
            <div class="relative z-0 w-full mb-5 group" >
                ...
                name="goal[goals_name]"  value="{{$goal->goals_name}}" 
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                value="{{ $goal->goals_deadline}}" id="date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
