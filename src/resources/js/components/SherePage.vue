<template>
        ...
        <div class="count_page">
          <div class="left_box">
            ...
            <div class="count_down">
              ...
              <a src="" class="names_list" v-for="goal in user.goals" :key="user.goals.id">
          ...
          <div class="right_box">
            <count-down-timer :data="user.point" :key="count" />
          </div>
        </div>
  ...
  <div v-if="showPublshed" class="modal">
    <p> 公開中...</p>
    <p>{{ num5 }}</p>
    <p>{{ modalId }}</p>

    <button @click="toggleGoajShowModal">閉じる</button>
    <button @click="priDone = true">できた！</button>
    <div v-if="priDone" class="modal">
      <div class="img_studing">
